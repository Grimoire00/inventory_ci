...
<head>
  ...
  <link rel="shortcut icon" href="<?php echo base_url()?>assets/images/log/skinc.jpg">
</head>
<body>
 <section class="h-100 w-100" style="box-sizing: border-box; background-color: #f5f5f5">
  ...
  <div class="content-4-1 d-flex bg-danger flex-column align-items-center h-100 flex-lg-row"
  style="font-family: 'Poppins', sans-serif">
  <div class="position-relative d-none d-lg-block h-100 width-left" >
    <img class="position-absolute img-fluid centered"
    src="<?php echo base_url()?>assets/images/log/skinc.jpg"
    style="width: 80%;"
    alt="" />
  </div>
  ...
  <br>
  <button class="btn btn-danger text-white d-block w-100" type="submit">
